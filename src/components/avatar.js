      ...
      if (net) {
        ...
        for (let pose of poses) {
          ...
          if (nose.score >= 0.5 && lear.score >= 0.5 && rear.score >= 0.5) {
            ...
            tempCtx.drawImage(
              videoElement,
              lear.position.x * scaleX,
              (lear.position.y -
                ((rear.position.x - lear.position.x) * 1.3) / 2) *
                scaleY,
              (rear.position.x - lear.position.x) * scaleX,
              (rear.position.x - lear.position.x) * 1.3 * scaleY,
              nose.position.x - 50,
              canvasElement.height / 2 - 130 / 2,
              100,
              130
            );
